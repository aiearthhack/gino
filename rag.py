...
def hybrid_search(query, user_id, index_name="gino-vector-search-index"):
    ...
    endpoint = f"{ai_search_endpoint}/indexes/{index_name}/docs/search?api-version=2023-11-01"
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"Error performing hybrid search. Status code: {response.status_code}")
